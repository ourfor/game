...
public class Bullets {
	...
	private static final Map<String, Image> images = new HashMap<String, Image>(); // 定义Map键值对，是不同方向对应不同的弹头
	...
	static {
		...
		images.put("L", bulletImages[0]); // 加入Map容器
		...
		images.put("RU", bulletImages[6]);

		images.put("LU", bulletImages[5]);

		images.put("RD", bulletImages[7]);

		images.put("LD", bulletImages[4]);
